...
function Navbar() {
  const [navBarActiveClass, setNavBarActiveClass] = useState("hidden md:visible");
    ...
    return (
      <nav role="navigation" aria-label="main-navigation">
        <div className="container m-auto py-6 flex flex-wrap justify-start items-center">
          ...
          <div
            className={`block w-full md:w-auto md:flex md:items-start px-6 ${
              navBarActiveClass
            }`}
          >
...
// const NavbarClass = class extends React.Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       active: false,
